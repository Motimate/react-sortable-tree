...
function (_Component) {
  ...
  _createClass(ReactSortableTree, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var newState = _objectSpread2({}, this.state);

      var isTreeDataEqual = isEqual(instanceProps.treeData, this.props.treeData); // make sure we have the most recent version of treeData
