...
function (_Component) {
  ...
  _createClass(ReactSortableTree, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      var instanceProps = _objectSpread2({}, prevState.instanceProps);

      var newState = _objectSpread2({}, this.state); // make sure we have the most recent version of treeData


      var isTreeDataEqual = isEqual(instanceProps.treeData, this.props.treeData); // if it is not the same then call the onDragStateChanged
